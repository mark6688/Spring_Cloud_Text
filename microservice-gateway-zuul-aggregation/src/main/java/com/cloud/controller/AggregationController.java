...
import com.cloud.ZuulApplication;
import com.cloud.entity.User;
import com.cloud.service.AggregationService;
...
public class AggregationController {
    ...
    public DeferredResult<HashMap<String,User>> aggregate(@PathVariable Long id){
        Observable<HashMap<String,User>> retult = this.aggregateObservable(id);
        return this.toDeferredResult(retult);
    }

    public Observable<HashMap<String,User>> aggregateObservable(Long id){
        //合并连个或者多个Observables发射出的数据项，根据指定的函数变换它们
