...
public class VideoAsyncScanResultsSample extends BaseSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        aaa.add("vi3zoyMl0gQ0t5PGt8@kRnqQ-1ocfSv");
        aaa.add("viWWw3BnRAuj6UzyL8FO2a5-1ocfSN");

        /*data.add("vi3zoyMl0gQ0t5PGt8@kRnqQ-1ocfSv");
        data.add("viWWw3BnRAuj6UzyL8FO2a5-1ocfSN");*/
        data.addAll(aaa);
